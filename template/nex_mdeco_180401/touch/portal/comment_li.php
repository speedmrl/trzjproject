...
<ul>
    <li>
        ...
        <dl id="comment_{$comment[cid]}_li" class="ptm pbm bbda cl">
            <dt class="mbm" style="height:20px; line-height:20px;margin-bottom:2px!important;">
                <div class="portrait">
                <a href="home.php?mod=space&uid=$comment[uid]" c="1"><!--{avatar($comment[uid],small)}--></a>
                </div>
                <span class="y xw0 xi2 nex_editse">
            ...
            <dd class="nex_Comsback"><!--{if $_G[adminid] == 1 || $comment[uid] == $_G[uid] || $comment[status] != 1}-->$comment[message]<!--{else}--> {lang moderate_not_validate}<!--{/if}--></dd>
        </dl>
    </li>
</ul>