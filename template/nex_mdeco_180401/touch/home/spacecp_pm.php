...
<!-- main post_msg_box start -->
	...
	<div class="post_msg_from">
		<ul>
			<!--{if !$touid}-->
			<li><input type="text" value="" tabindex="1" class="nex_input_pm px" size="30" autocomplete="off" id="username" name="username" placeholder="{lang addressee}"></li>
			<!--{/if}-->
			<li class="bl_none area">
				<textarea class="pt nex_input_pm" tabindex="2" autocomplete="off" value="" id="sendmessage" name="message" cols="80" rows="7"  placeholder="{lang thread_content}"></textarea>
			</li>
		</ul>
