...
<!--{if $sectpl}-->
	...
	<!--{/if}-->
	<!--{if $seccodecheck}-->
		<div class="sec_code vm nex_dl_sec_code">
		<input name="seccodehash" type="hidden" value="$sechash" />
		<input type="text" class="nex_reply_input" style="ime-mode:disabled;width:115px;background:white;" autocomplete="off" value="" id="seccodeverify_$sechash" name="seccodeverify" placeholder="{lang seccode}" fwin="seccode">
