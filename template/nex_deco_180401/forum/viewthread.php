...
<div class="nex_junctionport">
	<div class="nex_junctionport_inter">
        <div class="nex_author cl">
            ...
            <div class="nex_user">
                <a class="nex_lzname" href="home.php?mod=space&uid={$_G[forum_thread][authorid]}" target="_blank" title="访问我的空间" c="1">{$_G[forum_thread][author]}</a>
                <!--{loop $postlist $post}-->
                    <!--{if $post['first']}-->
                        ...
                        <!--{/loop}-->
                        <a href="home.php?mod=spacecp&ac=usergroup&gid=$post[groupid]" target="_blank" class="nex_grtxt">{$post[authortitle]}</a>
                    <!--{/if}-->
                <!--{/loop}-->
                </div>
                <!--{if $_G['medal_list']}-->
                ...
                <!--{if $thread[authorid] != $_G[uid]}-->
                      <ul class="user_contact cl">
                          <!--{if helper_access::check_module('follow')}-->
                              <li class="user_flw">
                                  <a href="home.php?mod=spacecp&ac=pm&op=showmsg&handlekey=showmsg_{$_G[forum_thread][authorid]}&touid={$_G[forum_thread][authorid]}&pmid=0&daterange=2&tid={$_G[tid]}" onclick="showWindow('sendpm', this.href);" title="{lang viewthread_left_sendpm}">发私信</a>
                               </li>
                               
                             <li class="user_pm"><a href="home.php?mod=space&uid={$_G[forum_thread][authorid]}" target="_blank">Ta的主页</a></li>
                             <li class="user_gets"><a href="home.php?mod=spacecp&ac=follow&op=add&hash={FORMHASH}&fuid=$post[authorid]" id="followmod_$post[authorid]" title="{lang follow}" class="xi2" onclick="showWindow('followmod', this.href, 'get', 0);">{lang follow}</a></li>
                              <!--{/if}-->
                         </ul>
                      <!--{/if}-->
            <!--{/if}-->
        ...
        <div class="nex_canyubox">
            <a class="nex_side_post" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=$_G[fid]')" href="javascript:;" title="{lang send_posts}">发布主题</a>
        <!--{if $allowpostreply && !$_G['forum_thread']['archiveid']}-->
            <a class="nex_side_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]')" href="javascript:;" title="{lang reply}">立刻回复</a>
        <!--{/if}-->
            <div class="clear"></div>
        </div>
        <div class="nex_curauthor_box">
            ...
            <div class="nex_curauthor_btm">
            	<ul>
                	<!--{loop $ucthread $nex_other_threads}-->
                    <li>
                    	<a href="forum.php?mod=viewthread&tid=$nex_other_threads[tid]" target="_blank"><!--{echo cutstr($nex_other_threads[subject],40)}--></a>
                    </li>
                    <!--{/loop}-->
                </ul>
            </div>
...
<div id="ct" class="wp cl {if $close_leftinfo} ct2{/if}">
    <div class="mn" <!--{if !$close_leftinfo}--> <script type="text/javascript" src='$_G['style'][styleimgdir]/js/jquery-1.8.3.min.js'></script>
        ...
        <div class="nex_normalfold_type">
            <a class="nex_normalfold_post" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=$_G[fid]')" href="javascript:;" title="{lang send_posts}">发布主题</a>
        <!--{if $allowpostreply && !$_G['forum_thread']['archiveid']}-->
            <a class="nex_normalfold_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]')" href="javascript:;" title="{lang reply}">立即回复</a>
        <!--{/if}-->
            <div class="clear"></div>
        </div>
        <!--{/if}-->
        ...
        <div class="vwthdtit cl">
            <!--{if $_G['setting']['close_leftinfo_userctrl']}-->
                ...
                <!--{if !$close_leftinfo}-->
                    <a onclick="setcookie('close_leftinfo', 1);location.reload();" title="{lang collapse_the_left}" class="btn_s_close" href="javascript:;"><img src="template/nex_deco_180401/neoconex/viewthread/control_l.png" alt="{lang collapse_the_left}" class="vm" /></a>
                <!--{else}-->
                    <a onclick="setcookie('close_leftinfo', 2);location.reload();" title="{lang open_the_left}" class="btn_s_open" href="javascript:;"><img src="template/nex_deco_180401/neoconex/viewthread/control_r.png" alt="{lang open_the_left}" class="vm" /></a>
                <!--{/if}-->
