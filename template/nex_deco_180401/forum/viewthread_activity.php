...
<div class="act pbm cl" style="margin-bottom:30px;">
	<div class="spvimg">
        ...
        <div class="nex_hdenter_btn">
                ...
                <!--{elseif !$activityclose}-->
                    <p class="nex_enterhd_pns">
                        <!--{if $isverified != 2}-->
                            <!--{if !$activity['number'] || $aboutmembers > 0}--><button class="nex_pn" value="true" name="ijoin" onclick="{if $_G['uid']}showDialog($('activityjoin').innerHTML, 'info', '{lang activity_join}'){else}showWindow('login', 'member.php?mod=logging&action=login&guestmessage=yes'){/if}"><span>{lang activity_join}</span></button><!--{/if}-->
                        <!--{else}-->
	...
	<div class="spi">
		<dl>
			<dd class="nex_hd_types">{lang activity_type}:<em>$activity[class]</em></dd>
			<dd class="nex_hd_starttime">
			...
			<dd class="nex_hd_addressed">
				{lang activity_space}:<em>$activity[place]</em>
			</dd>
			<dd class="nex_hd_genders">
            	{lang gender}:
                <em>
            ...
            <dd class="nex_mageshds">
                <div class="nex_hdmagtxt">{lang activity_already}:</div>
                <div class="nex_hdnumeds">
