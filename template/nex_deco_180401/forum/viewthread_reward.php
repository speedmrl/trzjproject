...
<div class="rwd cl">
	<div class="nex_reardstitles">$_G[forum_thread][subject]</div>
	<div class="nex_rewardstxt">{lang thread_reward}<i>$rewardprice</i><span>{$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][2]][unit]}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][2]][title]} {if $_G['forum_thread']['price'] > 0}</span><em>(回答此问题，将获得$rewardprice 金钱奖励)</em></div>
    <div class="nex_rewardunsoluted">
        <span class="xi1"><em>状态</em>尚未解决,快来回答吧</span>{elseif $_G['forum_thread']['price'] < 0}<span class="xg1" style="margin-left:20px;"><em>状态</em>已解决,大家来学习学习</span>{/if}
    </div>
    <div class="clear"></div>

   
	
	<div class="nex_rewards_desc">
...
<!--{if $bestpost}-->
	<div class="rwdbst nex_bestansdfbx">
		<h3 class="nex_bestans">{lang reward_bestanswer}</h3>
		<div class="pstl">
