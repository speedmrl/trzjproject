<?php echo 'Copyright@Neoconex_星点互联';exit;?>
        ...
        <div class="w1180">
            ...
            <div class="mn">
                ...
                <div id="chart" class="bm bw0 cl">
                    <p class="chart z">
                        <span class="nex_jinri">{lang index_today}<br />$todayposts</span><span class="nex_zuori">{lang index_yesterday}<br />$postdata[0]</span><span class="nex_tiezishu">{lang index_posts}<br />$posts</span><span class="nex_shuzi">{lang index_members}<br />$_G['cache']['userstats']['totalmembers']</span></p>
                    <div class="y">
                ...
                <!--{/if}-->
                    ...
                    <!--{if empty($gid) && !empty($forum_favlist)}-->
                        ...
                        <div class="bm bmw {if $forumcolumns} flg{/if} cl">
                            <div class="bm_h cl">
                                <span class="o">
                                    <img id="category_0_img" src="$_G['style'][styleimgdir]/discuz/$collapse['collapseimg_0']" title="{lang spread}" alt="{lang spread}" onclick="toggle_collapse('category_0');" />
                                </span>
                                    ...
                                    <!--{eval $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];}-->
                                        <!--{if $forumcolumns>1}-->
                                            ...
                                            <td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
                                                <div class="fl_icn_g nex_favbks nex_actions fadeIn"{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="width: {$forum[extra][iconwidth]}px;"{/if}>
                                                <!--{if $forum[icon]}-->
                                                    $forum[icon]
                                                <!--{else}-->
                    ...
                    <!--{loop $catlist $key $cat}-->
                        ...
                        <div class="bm bmw {if $cat['forumcolumns']} flg{/if} cl">
                            <div class="bm_h cl">
                                <span class="o">
                                    <img id="category_$cat[fid]_img" src="$_G['style'][styleimgdir]/discuz/$cat[collapseimg]" title="{lang spread}" alt="{lang spread}" onclick="toggle_collapse('category_$cat[fid]');" />
                                </span>
                                ...
                                <table cellspacing="0" cellpadding="0" class="fl_tb">
                                    ...
                                    <!--{if $cat['forumcolumns']}-->
                                        ...
                                        <td class="fl_g" width="$cat[forumcolwidth]">
                                            <div class="fl_icn_g nex_bbs_icon nex_actions fadeIn"{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="width: {$forum[extra][iconwidth]}px;"{/if}>
                                            <!--{if $forum[icon]}-->
                                                $forum[icon]
                                            <!--{else}-->
                                                <a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}><img src="{IMGDIR}/forum{if $forum[folder]}_new{/if}.gif" alt="$forum[name]" /></a>
                                            ...
                                            <!--{if $forum[todayposts] && !$forum['redirect']}-->
                                                <div class="nex_todayposts_bbs" title="{lang forum_todayposts}"> $forum[todayposts]</div>
                                            <!--{/if}-->
                                            </div>
                                            <dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
                                                <dt>
