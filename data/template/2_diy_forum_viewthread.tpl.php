...
0
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/nex_deco_180401/forum/viewthread_node.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/nex_deco_180401/forum/viewthread_fastpost.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/nex_deco_180401/forum/viewthread_node_body.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/default/common/seditor.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/default/common/upload.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
|| checktplrefresh('./template/nex_deco_180401/forum/viewthread.htm', './template/default/common/seccheck.htm', 1598114600, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/nex_deco_180401', 'forum/viewthread')
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_top'])) echo $_G['setting']['pluginhooks']['viewthread_top'];?><?php echo adshow("text/wp a_t");?><div id="pt" class="bm cl">
    <div class="z">
        <a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
    </div>
</div>
<style id="diy_style" type="text/css"></style>
<div class="wp">
...
<div class="nex_viewthreadads"><!--[diy=nex_viewthreadads]--><div id="nex_viewthreadads" class="area"></div><!--[/diy]--></div>
...
<div class="nex_junctionport_inter">
        <div class="nex_author cl">
            ...
            <div class="nex_user">
                <a class="nex_lzname" href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" title="访问我的空间" c="1"><?php echo $_G['forum_thread']['author'];?></a>
                <?php if(is_array($postlist)) foreach($postlist as $post) { ?>                    <?php if($post['first']) { ?>
                        ...
                        <?php } ?>
                        <a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['groupid'];?>" target="_blank" class="nex_grtxt"><?php echo $post['authortitle'];?></a>
                    <?php } ?>
                <?php } ?>
                </div>
                ...
                <div class="nex_medalbox">
                    <ul>
                    <?php if(is_array($_G['medal_list'])) foreach($_G['medal_list'] as $medalid => $medal) { ?>                        <li>
                            <img src="<?php echo $_G['style']['imgdir'];?>/<?php echo $medal['image'];?>"alt="" id="md_<?php echo $medal['medalid'];?>" onmouseover="showMenu({'ctrlid':this.id, 'menuid':'md_<?php echo $medal['medalid'];?>_menu', 'pos':'12!'});" initialized="true"/>
                            <div class="nex_medaltip_c">
                                <i class="nex_tip_horn"></i>
                                <h4><?php echo $medal['name'];?></h4>
                                <div class="nex_medaldes"><?php echo $medal['description'];?></div>
                            </div>
                        </li>
                    <?php } ?>
                    <div class="clear"></div>
                ...
                <?php if($thread['authorid'] != $_G['uid']) { ?>
                      <ul class="user_contact cl">
                          <?php if(helper_access::check_module('follow')) { ?>
                              <li class="user_flw">
                                  <a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $_G['forum_thread']['authorid'];?>&amp;touid=<?php echo $_G['forum_thread']['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;tid=<?php echo $_G['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息">发私信</a>
                               </li>
                               
                             <li class="user_pm"><a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank">Ta的主页</a></li>
                             <li class="user_gets"><a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $post['authorid'];?>" id="followmod_<?php echo $post['authorid'];?>" title="收听TA" class="xi2" onclick="showWindow('followmod', this.href, 'get', 0);">收听TA</a></li>
                              <?php } ?>
                         </ul>
                      <?php } ?>
            <?php } ?>
        ...
        <div class="nex_canyubox">
            <a class="nex_side_post" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a>
        <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
            <a class="nex_side_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">立刻回复</a>
        <?php } ?>
            <div class="clear"></div>
        </div>
        <div class="nex_curauthor_box">
            ...
            <div class="nex_curauthor_btm">
            	<ul>
                <?php if(is_array($ucthread)) foreach($ucthread as $nex_other_threads) { ?>                    <li>
                    	<a href="forum.php?mod=viewthread&amp;tid=<?php echo $nex_other_threads['tid'];?>" target="_blank"><?php echo cutstr($nex_other_threads['subject'],40); ?></a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
...
jQuery(elm).css('top',((p) > startPos) ? '43px' : ''); 
}); 
}); 
</script>
<?php } ?>
<div id="ct" class="wp cl <?php if($close_leftinfo) { ?> ct2<?php } ?>">
    <div class="mn" <?php if(!$close_leftinfo) { ?> <script type="text/javascript" src='<?php echo $_G['style']['styleimgdir'];?>/js/jquery-1.8.3.min.js'></script>
<script type="text/javascript" src='<?php echo $_G['style']['styleimgdir'];?>/js/jquery.SuperSlide.2.1.1.js'></script>
    	<?php if($modmenu['thread']) { ?>
        <div class="nex_gpop_pop" style="margin-bottom:10px;">
        ...
        <?php } ?>
        <div class="nex_normalfold_type">
            <a class="nex_normalfold_post" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a>
        <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
            <a class="nex_normalfold_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">立即回复</a>
        <?php } ?>
            <div class="clear"></div>
        </div>
        <?php } ?>
    	...
    	<div id="postlist" class="pl bm <?php if(!$close_leftinfo) { ?>nex_conone<?php } else { ?>nex_others<?php } ?>">
        ...
        <div class="vwthdtit cl">
            <?php if($_G['setting']['close_leftinfo_userctrl']) { ?>
                ...
                <?php if(!$close_leftinfo) { ?>
                    <a onclick="setcookie('close_leftinfo', 1);location.reload();" title="收起左侧" class="btn_s_close" href="javascript:;"><img src="template/nex_deco_180401/neoconex/viewthread/control_l.png" alt="收起左侧" class="vm" /></a>
                <?php } else { ?>
                    <a onclick="setcookie('close_leftinfo', 2);location.reload();" title="开启左侧" class="btn_s_open" href="javascript:;"><img src="template/nex_deco_180401/neoconex/viewthread/control_r.png" alt="开启左侧" class="vm" /></a>
                <?php } ?>
                
            <?php } ?>
            <?php if(!$close_leftinfo) { ?>
<div class="vwthduser cl z">
<?php if($_G['page'] > 1) { if($_G['forum_thread']['authorid'] && $_G['forum_thread']['author']) { ?>
...
jQuery(this).children(".vwthdewmsub").hide();
        ...
        <?php $postcount = 0;?>        <?php if(is_array($postlist)) foreach($postlist as $post) { ?>            <?php if($rushreply && $_GET['checkrush'] && $post['rewardfloor'] != 1) { ?>
                <?php continue;?>            <?php } ?> 
            <div id="post_<?php echo $post['pid'];?>" class="viewbox <?php if($post['first']) { ?>firstfloor<?php } else { ?>otherfloor<?php } ?> cl" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>>
...
<?php if(!$post['anonymous'] && $postshowavatars && $showavatars) { ?>
    ...
    <?php } else { ?>
    	<img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/hidden.png" />
    <?php } ?>
</div>
<?php } if($close_leftinfo && !$post['first']) { ?>
<div class="viewinfo">
...
<?php } } else { ?>
            	<div class="avatar"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/hidden.png" /></div>
<div class="pi">
                    <div class="authi">
...
<?php } ?>
                ...
                <div class="foldcount y">
                    ...
                    <em><?php echo $_G['forum_thread']['views'];?></em>
                    <span class="foldreplies"></span>
                    <em><?php echo $_G['forum_thread']['allreplies'];?></em>
                </div>
                <?php } ?>
                <?php if(!$close_leftinfo || !$post['first']) { ?>
<strong>
...
<div class="authi <?php if($post['first'] ) { ?>firstauthi<?php } ?>">
...
<?php } if($close_leftinfo) { ?><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2"><?php echo $post['author'];?></a><?php echo $authorverifys;?><?php } if($close_leftinfo) { } ?>
...
<?php } } } elseif(getstatus($post['status'], 5)) { if($close_leftinfo) { ?><a href="javascript:;" class="xi2"><?php echo $post['author'];?></a><?php } ?>
&nbsp;<em id="authorposton<?php echo $post['pid'];?>">发表于 <?php echo $post['dateline'];?></em>
...
<span class="none"><img src="<?php echo IMGDIR;?>/arw_r.gif" class="vm" alt="回帖奖励" /></span>
                    <?php } if(!$rushreply && !$close_leftinfo) { if($ordertype != 1) { ?>
...
<?php } } } if($post['first']) { ?>
<span class="pipe <?php if(!$close_leftinfo) { ?>show<?php } ?>">|</span><a href="javascript:;" onclick="readmode($('thread_subject').innerHTML, <?php echo $post['pid'];?>);" class="<?php if(!$close_leftinfo) { ?>show<?php } ?>">阅读模式</a>
<?php } if($close_leftinfo && $post['first']) { ?>
<span class="pl10">
<?php if($post['invisible'] == 0) { ?><a href="forum.php?mod=viewthread&amp;action=printable&amp;tid=<?php echo $_G['tid'];?>" title="打印" target="_blank"><img src="<?php echo IMGDIR;?>/print.png" alt="打印" class="vm" /></a>
<?php } ?>
...
<!-- /mod_viewthread.php原接口/ -->
        ...
        <?php if($threadsort && $threadsortshow) { ?>

        <div class="nex_sortmains">
            <?php if($threadsortshow['typetemplate']) { ?>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/favourite.png" alt="收藏" /><div class="nex_icon_bottom"><span class="nex_sc">收藏</span><span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></div></a>
...
<a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="评分表立场">
                        <img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/agree.png" alt="评分" />
                        <div class="nex_icon_bottom"><span class="nex_sc">评分</span></div>
                        </a>
<?php } if(!$post['anonymous'] && $post['first'] && helper_access::check_module('follow')) { ?>
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/zhuanbo.png" alt="转播" />
                        <div class="nex_icon_bottom"><span class="nex_sc">转播</span><?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" ><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></div>
                        
                        </a>
<?php } if($post['first'] && helper_access::check_module('share')) { ?>
<a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/share.png" alt="分享" /><div class="nex_icon_bottom"><span class="nex_sc">分享<?php if($_G['forum_thread']['sharetimes']) { ?></span><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></div></a>
<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/taotie.png" alt="分享" />
                        
                        <div class="nex_icon_bottom"><span class="nex_sc">淘帖</span><span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> <?php } ?>><?php echo $post['releatcollectionnum'];?></span></div>
                        
                        </a>
<?php } if(($_G['group']['allowrecommend'] || !$_G['uid']) && $_G['setting']['recommendthread']['status']) { if(!empty($_G['setting']['recommendthread']['addtext'])) { ?>
<a id="recommend_add" href="forum.php?mod=misc&amp;action=recommend&amp;do=add&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_add').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['addtext'];?>'" title="顶一下"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/check.png" alt="<?php echo $_G['setting']['recommendthread']['addtext'];?>" /><div class="nex_icon_bottom"><span class="nex_sc"><?php echo $_G['setting']['recommendthread']['addtext'];?></span><span id="recommendv_add"<?php if(!$_G['forum_thread']['recommend_add']) { ?> <?php } ?>><?php echo $_G['forum_thread']['recommend_add'];?></span></div></a>
<?php } if(!empty($_G['setting']['recommendthread']['subtracttext'])) { ?>
<a id="recommend_subtract" href="forum.php?mod=misc&amp;action=recommend&amp;do=subtract&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(-<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_subtract').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['subtracttext'];?>'" title="踩一下"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/close.png" alt="<?php echo $_G['setting']['recommendthread']['subtracttext'];?>" /><div class="nex_icon_bottom"><span class="nex_sc"><?php echo $_G['setting']['recommendthread']['subtracttext'];?></span><span id="recommendv_subtract"<?php if(!$_G['forum_thread']['recommend_sub']) { ?> <?php } ?>><?php echo $_G['forum_thread']['recommend_sub'];?></span></div></a>
<?php } } ?>
...
<ul class="xl xl2 cl nex_threadslists"><?php if(is_array($post['relateitem'])) foreach($post['relateitem'] as $var) { ?><li>
...
<?php } if($post['first'] && $close_leftinfo && $_G['forum_thread']['allreplies']) { ?>
<div class="allrepliestit" id="detail-tag3">
<div class="allrepliesw cl">
    	<h2 class="z">精彩评论<em><?php echo $_G['forum_thread']['allreplies'];?></em></h2>
        ...
        <?php if(!$postcount ) { ?>
            <div id="fj" class="y">
                ...
                <a href="javascript:;" id="fj_btn" class="z" title="跳转到指定楼层"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/fj_btn.png" alt="跳转到指定楼层" class="vm" /></a>
            </div>
        <?php } ?>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_endline'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_endline'][$postcount];?>
    ...
    <?php $nxtpage = $page + 1;?>        <div class="pgbtn"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true">下一页 &raquo;</a></div>
    <?php } ?>
...
<?php if($_G['uid']) { ?>
                ...
                <?php } else { ?>
                <div class="nex_unlog_avator"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/default_avator1.png" /></div>
                <?php } ?>
...
</span><?php $seditor = array('fastpost', array('at', 'bold', 'color', 'img', 'link', 'quote', 'code', 'smilies'), !$allowfastpost ? 1 : 0, $allowpostattach && $_GET['from'] != 'preview' && $allowfastpost ? '<span id="spanButtonPlaceholder">'.lang('template', 'upload').'</span>' : '');?><?php if(!empty($_G['setting']['pluginhooks']['viewthread_fastpost_ctrl_extra'])) echo $_G['setting']['pluginhooks']['viewthread_fastpost_ctrl_extra'];?><script src="<?php echo $_G['setting']['jspath'];?>seditor.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<div class="fpd">
...
<div class="sd">
        <?php if($modmenu['thread']) { ?>
<div class="nex_sdpart">
<a href="javascript:;" id="nex_guanli" onmouseover="showMenu({'ctrlid':'nex_new_guanli'});">主题管理</a>
<?php if($modmenu['thread']) { ?>
            <div id="nex_new_guanli_menu" class="p_pop kmp_pop" style="display: none;">
                <?php $modopt=0;?>                <?php if($_G['forum']['ismoderator']) { ?>
                    <?php if($_G['group']['allowdelpost']) { $modopt++?><a href="javascript:;" onclick="modthreads(3, 'delete')">删除主题</a><span class="pipe">|</span><?php } ?>
                    <?php if($_G['group']['allowbumpthread'] && !$_G['forum_thread']['is_archived']) { $modopt++?><a href="javascript:;" onclick="modthreads(3, 'bump')">升降</a><span class="pipe">|</span><?php } ?>
                    <?php if($_G['group']['allowstickthread'] && ($_G['forum_thread']['displayorder'] <= 3 || $_G['adminid'] == 1) && !$_G['forum_thread']['is_archived']) { $modopt++?><a href="javascript:;" onclick="modthreads(1, 'stick')">置顶</a><span class="pipe">|</span><?php } ?>
...
<!--精品案例展示-->
        <div class="nex_sdbox">
        	<div class="nex_sdbox_top"><span>精品案例展示</span><a href="#" target="_blank">...</a><div class="clear"></div></div>
            <div class="nex_caseshow">
            	<ul>
                	<!--[diy=nex_caseshow]--><div id="nex_caseshow" class="area"></div><!--[/diy]-->
        ...
        <!--阅读排行-->
        <div class="nex_sdbox">
        	<div class="nex_sdbox_top"><span>阅读排行</span><a href="#" target="_blank">...</a><div class="clear"></div></div>
            <div class="nex_rankreads">
            	<ul>
                	<!--[diy=nex_rankreads]--><div id="nex_rankreads" class="area"></div><!--[/diy]-->
