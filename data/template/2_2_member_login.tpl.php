...
0
|| checktplrefresh('./template/nex_deco_180401/member/login.htm', './template/default/common/seccheck.htm', 1598149372, '2', './data/template/2_2_member_login.tpl.php', './template/nex_deco_180401', 'member/login')
...
</style><?php $loginhash = 'L'.random(4);?><?php if(empty($_GET['infloat'])) { ?>
<div id="ct" class="ptm wp w cl nex_dl_aeras">
    ...
    <div class="nex_denglu_box" id="main_messaqge_<?php echo $loginhash;?>"<?php if($auth) { ?> style="width: auto"<?php } ?>>
...
<?php } ?>                    <?php } ?>
    ...
    <?php updatesession();?>    <?php if(empty($_GET['infloat'])) { ?>
        </div></div></div></div>
