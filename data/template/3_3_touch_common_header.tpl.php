...
<script src="template/nex_mdeco_180401/neoconex/js/jquery.SuperSlide.2.1.1.js" type="text/javascript"></script> 
<script src="template/nex_mdeco_180401/neoconex/js/TouchSlide.1.1.js" type="text/javascript"></script> 
<link rel="stylesheet" href="template/nex_mdeco_180401/neoconex/style.css" type="text/css">
<script src="template/nex_mdeco_180401/neoconex/js/nexinorder.js" type="text/javascript" type="text/javascript"></script>
<script type="text/javascript">
$(function(){
$('.nexwaterfall').nex_inordered({ item: '.nexwateritems' });
});
</script>
<script src="template/nex_mdeco_180401/neoconex/js/nexactions.min.js" type="text/javascript"></script>
 <link rel="stylesheet" type="text/css" href="template/nex_mdeco_180401/neoconex/animate.min.css">
 <script>
 var wow = new WOW({boxClass: 'nexactions',});wow.init();
 </script>
 <script src="template/nex_mdeco_180401/neoconex/js/jquery.pagnation.js" type="text/javascript"></script>
</head>
...
<script src="template/nex_mdeco_180401/neoconex/js/main.js" type="text/javascript"></script>
